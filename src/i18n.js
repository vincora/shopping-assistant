        ...
        resources: {
            en: {
                translation: {
                    ...
                    emptyListDescription: `Add items to compare them <br /> by price per unit (kg,l etc.)`,
                    addButton: 'Add',
                    backButton: 'Back',
                    notes: 'Notes',
                    pricePerPackage: 'Price per package',
                    amount: 'Amount (kilos, liters, pieces)',
            ...
            ru: {
                translation: {
                    ...
                    emptyListDescription: 'Добавьте товары для сравнения  <br /> по цене за кг/литр и т.д.',
                    addButton: 'Добавить',
                    backButton: 'Назад',
                    notes: 'Заметки',
                    pricePerPackage: 'Цена за упаковку',
                    amount: 'Количество (кг, литры, штуки)',
